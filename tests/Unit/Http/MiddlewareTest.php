...
class MiddlewareTest extends UnitTestCase
{
    ...
    public function testParseMultipartResponse()
    {
        ...
        $inner = new Promise(static function () use (&$inner) { $inner->resolve(new \GuzzleHttp\Psr7\Response(200, ['Content-Type' => ['multipart/mixed; boundary=batch_e115af19-2deb-4ed7-be7d-cc2e43699be1']])); });
